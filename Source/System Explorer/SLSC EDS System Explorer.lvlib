	...
	<Item Name="System Explorer" Type="Folder">
		...
		<Item Name="Dynamically Called" Type="Folder">
			...
			<Item Name="Actions" Type="Folder">
				<Item Name="ActionVIOnCompile.vi" Type="VI" URL="../Dynamically Called/Actions/ActionVIOnCompile.vi"/>
				<Item Name="ActionVIOnLoad.vi" Type="VI" URL="../Dynamically Called/Actions/ActionVIOnLoad.vi"/>
				<Item Name="ActionVIOnDelete.vi" Type="VI" URL="../Dynamically Called/Actions/ActionVIOnDelete.vi"/>
			</Item>
			...
			<Item Name="Extra Pages" Type="Folder">
				<Property Name="NI.SortType" Type="Int">0</Property>
				<Item Name="Channel Interface.vi" Type="VI" URL="../Dynamically Called/Extra Pages/Channel Interface.vi"/>
				<Item Name="Command Channel Page.vi" Type="VI" URL="../Dynamically Called/Extra Pages/Command Channel Page.vi"/>
				<Item Name="Incoming Channels.vi" Type="VI" URL="../Dynamically Called/Extra Pages/Incoming Channels.vi"/>
				<Item Name="Outgoing Channels.vi" Type="VI" URL="../Dynamically Called/Extra Pages/Outgoing Channels.vi"/>
				<Item Name="Properties Root Page.vi" Type="VI" URL="../Dynamically Called/Extra Pages/Properties Root Page.vi"/>
				<Item Name="Properties Section Page.vi" Type="VI" URL="../Dynamically Called/Extra Pages/Properties Section Page.vi"/>
				<Item Name="Status Channel Page.vi" Type="VI" URL="../Dynamically Called/Extra Pages/Status Channel Page.vi"/>
			</Item>
