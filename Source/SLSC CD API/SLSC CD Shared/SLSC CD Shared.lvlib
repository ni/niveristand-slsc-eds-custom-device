...
<Library LVVersion="19008000">
	...
	<Item Name="SLSC Define Resource Name.vi" Type="VI" URL="../SLSC Define Resource Name.vi"/>
	<Item Name="SLSC Dynamic Channel.ctl" Type="VI" URL="../../SLSC CD Engine/SLSC Dynamic Channel.ctl"/>
	<Item Name="SLSC Error Suppression.vi" Type="VI" URL="../SLSC Error Suppression.vi"/>
	<Item Name="SLSC Identification.ctl" Type="VI" URL="../../SLSC CD Engine/SLSC Identification.ctl"/>
	<Item Name="SLSC Parse Path String.vi" Type="VI" URL="../SLSC Parse Path String.vi"/>
</Library>
